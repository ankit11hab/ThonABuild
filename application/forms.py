...
class AddRowForm(FlaskForm):
    ...
    frequency = StringField('Frequency', render_kw={
                            "placeholder": "Frequency"})
    event_date = StringField('Event Date', render_kw={
    ...
    employee_details = StringField('Employee details', render_kw={
                                   "placeholder": "Employee details"})
    event_code = StringField('Event code', render_kw={
                             "placeholder": "Event code"})
    action_perform = StringField('Action perform', render_kw={
                                 "placeholder": "Action perform"})
    notification_controller = StringField('Notification controller', render_kw={
                                          "placeholder": "Notification controller"})
    notification_event = StringField('Notification event', render_kw={
